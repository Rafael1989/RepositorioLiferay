...
/**
 * Provides the local service interface for Contrato. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Rafael
 * @see ContratoLocalServiceUtil
...
public interface ContratoLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ContratoLocalServiceUtil} to access the contrato local service. Add custom service methods to {@link br.com.gndi.liferay.service.impl.ContratoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
